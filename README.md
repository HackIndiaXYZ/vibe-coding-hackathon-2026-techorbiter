...
👉 **[Watch HIREVIUM Demo on YouTube](https://www.youtube.com/watch?v=SJ4Q15f2BBY)**
...
The diagram below illustrates how candidate metadata flows through HIREVIUM's specialized AI agents to generate real-time evaluations and recruiter decision telemetry:
...
*   `GET /api/recruiter/candidates`: Retrieve all registered candidates ranked by their Hirevium score (includes skills).
...
Follow these steps to run the complete HIREVIUM system locally:
